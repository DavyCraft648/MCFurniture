...
class Main extends \pocketmine\plugin\PluginBase{
	...
	protected function onEnable() : void{
		...
		CustomiesBlockFactory::getInstance()->registerBlock(
			static fn() => new Basin(new BlockIdentifier($id), "Basin", new BlockTypeInfo(new BlockBreakInfo(2))),
			"mcfurniture:basin",
		...
		$id = BlockTypeIds::newId();
		CustomiesBlockFactory::getInstance()->registerBlock(
			static fn() => new Bath(new BlockIdentifier($id), "Bath", new BlockTypeInfo(new BlockBreakInfo(0.3))),
			"mcfurniture:bath",
		...
		$id = BlockTypeIds::newId();
		CustomiesBlockFactory::getInstance()->registerBlock(
			static fn() => new Bin(new BlockIdentifier($id), "Bin", new BlockTypeInfo(new BlockBreakInfo(0.3))),
			"mcfurniture:bin",
		...
		$id = BlockTypeIds::newId();
		CustomiesBlockFactory::getInstance()->registerBlock(
			static fn() => new Candle(new BlockIdentifier($id), "Candle", new BlockTypeInfo(new BlockBreakInfo(0.3))),
			"mcfurniture:candle",
		...
		$id = BlockTypeIds::newId();
		CustomiesBlockFactory::getInstance()->registerBlock(
			static fn() => new CeilingLight(new BlockIdentifier($id), "Ceiling Light", new BlockTypeInfo(new BlockBreakInfo(0.3))),
		...
		foreach(["acacia", "andesite", "birch", "dark_oak", "diorite", "granite", "jungle", "oak", "spruce", "stone"] as $variant){
			$id = BlockTypeIds::newId();
			CustomiesBlockFactory::getInstance()->registerBlock(
				static fn() => new BedsideCabinet(new BlockIdentifier($id), "Bedside Cabinet", new BlockTypeInfo(new BlockBreakInfo(2))),
			...
			$id = BlockTypeIds::newId();
			CustomiesBlockFactory::getInstance()->registerBlock(
				static fn() => new Chair(new BlockIdentifier($id), "Chair", new BlockTypeInfo(new BlockBreakInfo(0.3))),
			...
			$id = BlockTypeIds::newId();
			CustomiesBlockFactory::getInstance()->registerBlock(
				static fn() => new Table(new BlockIdentifier($id), "Table", new BlockTypeInfo(new BlockBreakInfo(1))),
		...
		$id = BlockTypeIds::newId();
		CustomiesBlockFactory::getInstance()->registerBlock(
			static fn() => new Chimney(new BlockIdentifier($id), "Chimney", new BlockTypeInfo(new BlockBreakInfo(0.3))),
			"mcfurniture:chimney",
		...
		$id = BlockTypeIds::newId();
		CustomiesBlockFactory::getInstance()->registerBlock(
			static fn() => new Chair(new BlockIdentifier($id), "Toilet", new BlockTypeInfo(new BlockBreakInfo(0.3))),
			"mcfurniture:toilet",
		...
		foreach([
			...
			$id = BlockTypeIds::newId();
			CustomiesBlockFactory::getInstance()->registerBlock(
				static fn() => new BarStool(new BlockIdentifier($id), "Bar Stool", new BlockTypeInfo(new BlockBreakInfo(0.3))),
			...
			$id = BlockTypeIds::newId();
			CustomiesBlockFactory::getInstance()->registerBlock(
				static fn() => new DigitalClock(new BlockIdentifier($id), "Digital Clock", new BlockTypeInfo(new BlockBreakInfo(0.3))),
			...
			$id = BlockTypeIds::newId();
			CustomiesBlockFactory::getInstance()->registerBlock(
				static fn() => new Lamp(new BlockIdentifier($id), "Lamp", new BlockTypeInfo(new BlockBreakInfo(0.3))),
			...
			$id = BlockTypeIds::newId();
			CustomiesBlockFactory::getInstance()->registerBlock(
				static fn() => new StoneCabinet(new BlockIdentifier($id), "Terracotta Cabinet", new BlockTypeInfo(new BlockBreakInfo(2))),
		...
		$id = BlockTypeIds::newId();
		CustomiesBlockFactory::getInstance()->registerBlock(
			static fn() => new FairyLight(new BlockIdentifier($id), "Fairy Light", new BlockTypeInfo(new BlockBreakInfo(0.3))),
		...
		foreach(["acacia", "birch", "dark_oak", "jungle", "oak", "spruce"] as $variant){
			$id = BlockTypeIds::newId();
			CustomiesBlockFactory::getInstance()->registerBlock(
				static fn() => new Cabinet(new BlockIdentifier($id), "Wooden Cabinet", new BlockTypeInfo(new BlockBreakInfo(2))),
			...
			$id = BlockTypeIds::newId();
			CustomiesBlockFactory::getInstance()->registerBlock(
				static fn() => new Blinds(new BlockIdentifier($id), "Blinds", new BlockTypeInfo(new BlockBreakInfo(0.3))),
			...
			$id = BlockTypeIds::newId();
			CustomiesBlockFactory::getInstance()->registerBlock(
				static fn() => new Chair(new BlockIdentifier($id), "Park Bench", new BlockTypeInfo(new BlockBreakInfo(0.3))),
		...
		foreach(["andesite", "diorite", "granite", "stone"] as $variant){
			$id = BlockTypeIds::newId();
			CustomiesBlockFactory::getInstance()->registerBlock(
				static fn() => new StoneCabinet(new BlockIdentifier($id), "Stone Cabinet", new BlockTypeInfo(new BlockBreakInfo(2))),
				"mcfurniture:{$variant}_cabinet",
		...
		$id = BlockTypeIds::newId();
		CustomiesBlockFactory::getInstance()->registerBlock(
			static fn() => new WallCabinet(new BlockIdentifier($id), "Wall Cabinet", new BlockTypeInfo(new BlockBreakInfo(0.3))),
		...
		$id = BlockTypeIds::newId();
		CustomiesBlockFactory::getInstance()->registerBlock(
			static fn() => new ChristmasTree(new BlockIdentifier($id), "Christmas Tree", new BlockTypeInfo(new BlockBreakInfo(0.3))),
